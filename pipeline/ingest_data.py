...
@click.option('--year', default=2021, show_default=True, type=int, help='Trip data year.')
@click.option('--month', default=1, show_default=True, type=int, help='Trip data month (1-12).')
@click.option('--chunksize', default=100000, show_default=True, type=int, help='Rows per chunk to ingest.')
